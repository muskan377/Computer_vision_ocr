...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Drop references to the raw upload buffers now
            # that they're safely on disk, so this memory is
            # freed before the (heavier) analyze() call runs
            # instead of staying resident for the whole request.
            del body, parts, part, content
